...
class House:
    '''
    A class to create a house object from www.immoweb.be
    ...
    def __init__(self, url):
        ...
        The object has 1 parameter: the url of the house on www.immoweb.be
        '''
        self.url = url
    ...
    def scrape_house(self):
        ...
        '''
        #Screen the url. If 'new-real-estate-project-apartments' is in the url, ignore the url
        ...
        if type_house == 'new-real-estate-project-apartments':
            ...
            # Add furnished to the house dictionary. Info is in binary code if present
            ...
            # Add Open fire to the house dictionary. Info is in binary code if present
